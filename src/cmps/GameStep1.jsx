...
export function GameStep1({ setIsClickOnContinue, game, currStageIdx, moveToNextStage, onResetActivityIdx, currActivityIdx, onMoveToNextActivity, currActivityStepIdx, setCurrActivityStepIdx, currStageStepIdx, setCurrStageStepIdx }) {
